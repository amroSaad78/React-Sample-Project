...
exports.UserImageController = void 0;
var userImageService_1 = require("../services/userImageService");
...
var UserImageController = (function () {
    function UserImageController(userImageService, validator) {
        var _this = this;
        ...
        this.getImage = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4, this.userImageService.get(id)];
                    case 2:
        ...
        this.updateImage = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4, this.userImageService.update(file.tempFilePath, mime, id)];
                    case 3:
                        respone = _a.sent();
        ...
        this.deleteImage = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4, this.userImageService.delete(id)];
                    case 2:
                        respone = _a.sent();
                        res.status(respone.statusCode).json(respone.object);
                        return [3, 4];
        ...
        this.truncateImage = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4, this.userImageService.truncate(id)];
                    case 2:
                        _a.sent();
                        next();
                        return [3, 4];
    ...
    UserImageController = __decorate([
        (0, tsyringe_1.autoInjectable)(),
        __metadata("design:paramtypes", [userImageService_1.UserImageService,
            validator_1.Validator])
    ], UserImageController);
    return UserImageController;
}());
exports.UserImageController = UserImageController;
