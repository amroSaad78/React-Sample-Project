...
exports.CodeVerficationController = void 0;
var verficationService_1 = require("../services/verficationService");
...
var CodeVerficationController = (function () {
    function CodeVerficationController(verficationService, validator, decoder) {
        var _this = this;
        ...
        this.verifyCode = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, email, code, respone, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4, this.verficationService.verify(email.trim().toLowerCase(), code.trim())];
                    case 2:
                        respone = _b.sent();
    ...
    CodeVerficationController = __decorate([
        (0, tsyringe_1.autoInjectable)(),
        __metadata("design:paramtypes", [verficationService_1.VerficationService,
            validator_1.Validator,
            decoder_1.Decoder])
    ], CodeVerficationController);
    return CodeVerficationController;
}());
exports.CodeVerficationController = CodeVerficationController;
