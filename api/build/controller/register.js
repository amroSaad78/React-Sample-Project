...
var RegisterController = (function () {
    function RegisterController(registerService, validator, decoder) {
        var _this = this;
        this.registerService = registerService;
        this.validator = validator;
        this.decoder = decoder;
        this.register = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, name, email, password, error, user, respone, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        error = this.validate(name, email, password);
                        if (error)
                            return [2, next(error)];
                    ...
                    case 2:
                        ...
                        return [4, this.registerService.register(user)];
                    case 3:
                        respone = _b.sent();
        ...
        this.validate = function (name, email, password) {
            _this.validator
                .reset()
