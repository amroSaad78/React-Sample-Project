...
exports.CodeRequestController = void 0;
var codeRequestService_1 = require("../services/codeRequestService");
...
var CodeRequestController = (function () {
    function CodeRequestController(codeRequestService, validator, decoder) {
        var _this = this;
        this.codeRequestService = codeRequestService;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4, this.codeRequestService.request(email.trim().toLowerCase())];
                    case 2:
                        respone = _a.sent();
    ...
    CodeRequestController = __decorate([
        (0, tsyringe_1.autoInjectable)(),
        __metadata("design:paramtypes", [codeRequestService_1.CodeRequestService,
            validator_1.Validator,
            decoder_1.Decoder])
    ], CodeRequestController);
    return CodeRequestController;
}());
exports.CodeRequestController = CodeRequestController;
