...
var LoginController = (function () {
    function LoginController(loginService, validator, decoder) {
        var _this = this;
        this.loginService = loginService;
        this.validator = validator;
        this.decoder = decoder;
        this.login = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, email, password, error, respone, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        error = this.validate(email, password);
                        if (error)
                            return [2, next(error)];
                        return [4, this.loginService.login(email.trim().toLowerCase(), password.trim())];
                    case 2:
                        respone = _b.sent();
