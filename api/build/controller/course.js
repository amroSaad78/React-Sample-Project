...
var courseService_1 = require("../services/courseService");
...
var CourseController = (function () {
    function CourseController(courseService, validator) {
        var _this = this;
        this.courseService = courseService;
        this.validator = validator;
        this.create = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, name, details, error, course, respone, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, name = _a.name, details = _a.details;
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4, this.courseService.create(course)];
                    case 2:
                        respone = _b.sent();
        ...
        this.update = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var id, _a, name, details, error, respone, err_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        id = req.params.id;
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4, this.courseService.update(id, name.trim(), details.trim())];
                    case 2:
                        respone = _b.sent();
                        res.status(respone.statusCode).json(respone.object);
                        return [3, 4];
        ...
        this.del = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4, this.courseService.del(id)];
                    case 2:
                        respone = _a.sent();
                        res.status(respone.statusCode).json(respone.object);
                        return [3, 4];
        ...
        this.get = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4, this.courseService.get(parseInt(pageNo), parseInt(skip), criteria === null || criteria === void 0 ? void 0 : criteria.trim())];
                    case 2:
                        respone = _b.sent();
                        res.status(respone.statusCode).json(respone.object);
                        return [3, 4];
