...
var LoginService = (function () {
    function LoginService(repo, mailer) {
        var _this = this;
        this.repo = repo;
        this.mailer = mailer;
        this.namespace = "LoginService";
        this.login = function (email, password) { return __awaiter(_this, void 0, void 0, function () {
            var existingUser, isMatch, token, options, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!existingUser) {
                            throw { errMessage: errors_1.notFoundEmail, errno: 404 };
                        }
                        if (!existingUser.isActive) {
                            throw { errMessage: errors_1.authentication, errno: 401 };
                        }
                        if (!existingUser.getPassword()) {
                            throw { errMessage: errors_1.passwordError, errno: 400 };
                        }
                        return [4, bcrypt.compare(password, existingUser.getPassword())];
                    case 2:
                        isMatch = _a.sent();
                        if (!isMatch)
                            throw { errMessage: errors_1.passwordError, errno: 401 };
