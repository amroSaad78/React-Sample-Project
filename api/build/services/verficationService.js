...
var VerficationService = (function () {
    function VerficationService(repo) {
        var _this = this;
        this.repo = repo;
        this.namespace = "VerficationService";
        this.verify = function (email, code) { return __awaiter(_this, void 0, void 0, function () {
            var existingUser, expirationDate, currentDate, token, err_1;
